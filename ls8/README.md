...
cpu.c = cpu functions, input, output for function calls
cpu.h = cpu struct, cpu operations, cpu binary literals, function declarations
ls8.c = main function, init cpu, load cpu, run cpu
